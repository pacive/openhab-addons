...
public class TypeFactoryConstants {
    ...
    public static final List<ChannelTypeUID> STATUS_CHANNELS = List.of(CHANNEL_TYPE_COMPRESSOR,
            ...
            CHANNEL_TYPE_HEATING, CHANNEL_TYPE_COOLING, CHANNEL_TYPE_COOLING_PASSIVE, CHANNEL_TYPE_BRINE_PUMP,
            CHANNEL_TYPE_LAST_ACTIVITY, CHANNEL_TYPE_HAS_ALARMED, CHANNEL_TYPE_ALARM_INFO, CHANNEL_TYPE_SOFTWARE_UPDATE,
