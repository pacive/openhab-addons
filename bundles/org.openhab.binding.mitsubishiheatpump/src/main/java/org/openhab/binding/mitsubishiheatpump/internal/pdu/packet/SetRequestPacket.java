...
@NonNullByDefault
public class SetRequestPacket extends AbstractPacket implements MitsubishiHeatpumpPDU {
    private static final byte PACKET_TYPE = 0x41;

    public SetRequestPacket(byte[] data) throws SerialProtocolException {
        super(data);
    }

    public SetRequestPacket(MitsubishiHeatpumpCommand command) {
        super(command);
    }
