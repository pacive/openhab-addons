...
@NonNullByDefault
public class SetResponsePacket extends AbstractPacket implements MitsubishiHeatpumpPDU {
    private static final byte PACKET_TYPE = 0x61;

    private final boolean success;

    public SetResponsePacket(byte[] data) throws SerialProtocolException {
        super(data);
        this.success = data[5] == 0;
    }
