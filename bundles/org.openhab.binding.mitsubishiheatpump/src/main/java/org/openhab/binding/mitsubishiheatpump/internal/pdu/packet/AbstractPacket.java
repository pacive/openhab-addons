...
import org.openhab.binding.mitsubishiheatpump.internal.pdu.command.GenericCommand;
import org.openhab.binding.mitsubishiheatpump.internal.pdu.command.GetErrorStateCommand;
import org.openhab.binding.mitsubishiheatpump.internal.pdu.command.GetOperationStateCommand;
import org.openhab.binding.mitsubishiheatpump.internal.pdu.command.GetRunStatusCommand;
...
import org.openhab.binding.mitsubishiheatpump.internal.pdu.command.GetTimerModeCommand;
...
public abstract class AbstractPacket {
    ...
    protected MitsubishiHeatpumpCommand createCommand(byte[] data) throws SerialProtocolException {
        return switch (data[0]) {
            ...
            case 0x04 -> new GetErrorStateCommand(data);
            case 0x05 -> new GetTimerModeCommand(data);
            case 0x06 -> new GetOperationStateCommand(data);
            case 0x09 -> new GetRunStatusCommand(data);
