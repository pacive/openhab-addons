...
@NonNullByDefault
public class LegacyTSRoomTemperature extends AbstractRangeType implements MitsubishiHeatpumpType {
    private static final int MIN = 0x00;
    private static final int MAX = 0x1f;

    public LegacyTSRoomTemperature(int rawValue) throws SerialProtocolException {
        super(rawValue);
    }

    public LegacyTSRoomTemperature(byte value) throws SerialProtocolException {
        super(value);
    }

    public LegacyTSRoomTemperature(float value) throws SerialProtocolException {
